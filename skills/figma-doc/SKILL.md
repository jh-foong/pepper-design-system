---
name: figma-doc
description: Generate token-scanned, copy-paste Figma component descriptions for Pepper DS ii components. Runs a token scan against the component, flags old-DS tokens before writing anything, and produces a complete component description in the established Pepper DS format. Use whenever the user asks to document a Figma component, write its description, or check it for old design-system tokens.
---
